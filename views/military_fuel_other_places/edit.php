        ...
        <div class="col-md-6 mx-auto">
            <div class="card">
                <div class="card-header">
                    <h3>Редактировать вид заправок</h3>
                </div>
                <div class="card-body">
                    ...
                    <form action="/military-fuel-other-places/update/<?= $fuel['id'] ?>" method="POST">
                        <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="/military-fuel-other-places" class="btn btn-secondary">
