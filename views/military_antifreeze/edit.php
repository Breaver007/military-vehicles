        ...
        <div class="col-md-6 mx-auto">
            <div class="card">
                <div class="card-header">
                    <h3>Редактировать вид антифриза</h3>
                </div>
                <div class="card-body">
                    ...
                    <?php endif; ?>
                    <form action="/military-antifreeze/update/<?= $antifreeze['id'] ?>" method="POST">
                        <div class="mb-3">
                            <label for="name" class="form-label">Название антифриза *</label>
                            <input type="text" class="form-control" id="name" name="name"
                                   value="<?= htmlspecialchars($_SESSION['old']['name'] ?? $antifreeze['name']) ?>" required>
                        </div>
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="is_active" name="is_active" value="1"
                                    <?= ($_SESSION['old']['is_active'] ?? $antifreeze['is_active'] ?? false) ? 'checked' : '' ?>>
