        ...
        <div class="card-body">
            ...
            <div class="mb-4">
                ...
                <ol class="list-group list-group-numbered">
                    ...
                    <li class="list-group-item"><a href="#section-8">Учёт масел (Масла)</a></li>
                    <li class="list-group-item"><a href="#section-9">Учёт антифризов</a></li>
                </ol>
            </div>
                ...
                <div class="accordion" id="accordionCreate">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapse7" class="accordion-collapse collapse">
                            <div class="accordion-body">
                                <p>Вкладка <strong>"Масла"</strong> — 4-я таба в форме карточки:</p>
                                <ol>
                                    <li>Нажмите <strong>"+"</strong> — откроется модалка выбора масла</li>
                                    <li>Выберите вид масла из выпадающего списка и укажите количество</li>
                                    <li>Нажмите <strong>"Добавить"</strong> — запись появится в таблице</li>
                                    <li>Для удаления — нажмите корзину в строке</li>
                                    <li>Поле <strong>"Получено масел"</strong> рассчитывается автоматически как сумма всех записей</li>
                                </ol>
                                <p class="text-muted small">Справочник видов масел редактируется через меню <strong>Техника → Виды масел</strong>.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="section-8" class="mb-5">
                <h4 class="text-primary"><i class="bi bi-8-circle"></i> 8. Учёт масел (Масла)</h4>
                <p>Система позволяет вести справочник видов масел и учитывать их расход в путевых листах.</p>

                <h5>8.1 Справочник видов масел</h5>
                <p>Перейдите в <strong>Техника → Виды масел</strong> в меню:</p>
                <ul>
                    <li><strong>Список</strong> — отображает все добавленные виды масел (активные и неактивные)</li>
                    <li><strong>Добавить</strong> — создайте новый вид масла (указывается только название)</li>
                    <li><strong>Редактировать</strong> — измените название или статус активности</li>
                    <li><strong>Удалить</strong> — удалите запись (безвозвратно)</li>
                </ul>

                <h5>8.2 Расход масел в путевых листах</h5>
                <p>При создании/редактировании эксплуатационной карточки доступна вкладка <strong>"Масла"</strong>:</p>
                <ol>
                    <li>Нажмите <strong>"+"</strong> — откроется модальное окно</li>
                    <li>Выберите вид масла из выпадающего списка и укажите количество</li>
                    <li>Нажмите <strong>"Добавить"</strong> — запись появится в таблице</li>
                    <li>Поле <strong>"Получено масел"</strong> рассчитывается автоматически</li>
                </ol>
                <p class="text-muted small">Данные хранятся временно в сессии и сохраняются при отправке формы карточки.</p>
            </div>

            <!-- Раздел 9: Антифризы -->
            <div id="section-9" class="mb-5">
                <h4 class="text-primary"><i class="bi bi-9-circle"></i> 9. Учёт антифризов</h4>
                <p>Система позволяет вести справочник видов антифризов и создавать записи их расхода (отдельно от путевых листов).</p>

                <h5>9.1 Справочник видов антифризов</h5>
                <p>Перейдите в <strong>Техника → Антифризы</strong> в меню:</p>
                <ul>
                    <li><strong>Список</strong> — все виды антифризов</li>
                    <li><strong>Добавить</strong> — создайте новый вид (название)</li>
                    <li><strong>Редактировать</strong> — измените название или активность</li>
                    <li><strong>Удалить</strong> — удалите запись</li>
                </ul>

                <h5>9.2 Записи расхода антифриза</h5>
                <p>Перейдите в <strong>Техника → Записи антифриза</strong>:</p>
                <ul>
                    <li><strong>Список</strong> — таблица всех записей с датой, видом антифриза, техникой и количеством</li>
                    <li><strong>Добавить запись</strong> — укажите дату, выберите антифриз, технику и количество</li>
                    <li><strong>Редактировать / Удалить</strong> — изменить или удалить запись</li>
                </ul>
                <p class="text-muted small">Записи антифриза не привязаны к путевым листам и ведутся отдельно.</p>
            </div>
            <div class="mb-5">
